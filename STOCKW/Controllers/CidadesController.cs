...
namespace STOCKW.Controllers
{
    public class CidadesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID_Cidade,Nome,UF")] Cidade cidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID_Cidade,Nome,UF")] Cidade cidade)
        {
